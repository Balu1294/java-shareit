...
public class RequestServiceTest {
    ...
    public void addItemRequestWhenInvokedMethodReturnRequest() {
        ...
        assertEquals(RequestMapper.toRequestDto(request), requestService.addRequest(RequestMapper.toRequestDto(request), authorId));
    }
    ...
    public void addItemRequestWhenUserNotFoundThrowException() {
        ...
        assertThrows(NotFoundUserException.class, () -> requestService.addRequest(RequestMapper.toRequestDto(request), authorId));
    }
    ...
    public void getItemRequestsForUserWhenInvokedMethodReturnOneRequest() {
        ...
        assertEquals(RequestMapper.toRequestDtoList(itemRequests), requestService.getRequestsForUser(authorId));
    }
    ...
    public void getItemRequestByIdWhenInvokedMethodReturnBooking() {
        ...
        assertEquals(RequestMapper.toRequestDto(request), requestService.getRequestById(requestId, authorId));
    }
    ...
    public void deleteItemRequestWhenInvokedMethodReturnRequest() {
        ...
        assertEquals(RequestMapper.toRequestDto(request), requestService.deleteRequest(requestId, authorId));
    }
    ...
    public void getItemRequestsWhenInvokedMethodReturnOneBooking() {
        ...
        assertEquals(RequestMapper.toRequestDtoList(itemRequests), requestService.getRequests(GetRequest.of(ownerItemId, 0, 10)));
    }
